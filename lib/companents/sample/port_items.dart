  ...
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(
            ...
            border: Border.all(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.5), width: _getController.height.value * 0.003),
                    ...
                    children: [
                      if (data[0] != '')
                        SvgPicture.asset('assets/svg_assets/port.svg',
                            width: _getController.width.value * 0.022,
                            height: _getController.height.value * 0.022,
                      ...
                      Text(data[0].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                    ]
                )
              )
            ),
                ...
                child: Column(
                    children: [
                      if (data[1] != '')
                        ...
                        SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                      Text(data[1].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                    ]
                )
              )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[2] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[2].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[3] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[3].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[4] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[4].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[5] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[5].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            )
                    ...
                    child: Column(
                        children: [
                          if (data[7] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[7].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),Expanded(
                    ...
                    child: Column(
                        children: [
                          if (data[8] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[8].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),Expanded(
                    ...
                    child: Column(
                        children: [
                          if (data[9] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[9].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[10] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[10].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            ),
                    ...
                    child: Column(
                        children: [
                          if (data[11] != '')
                            ...
                            SizedBox(width: _getController.width.value * 0.03, height: _getController.height.value * 0.022),
                          Text(data[11].tr, style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.03))
                        ]
                    )
                )
            )
